package SeleniumMavenJenkins.SeleniumMavenJenkins;
...
public class End2EndTesting {
		...
		public Object[][] testdata_shoppingCart() {
			return new Object[][] { new Object[] { "IPhone", "2", "Adam", "MIAMI BEACH", "FL" },
		...
		public void tc_shoppingCartTesting(String item2Search, String qty, String customerName, String customerCity,
			...
			WebDriver driver;
			System.out.println("----End to End Testing Execution-----");
